...
void HAL_TIM_MspPostInit(TIM_HandleTypeDef* timHandle)
{
  ...
  /* USER CODE END TIM1_MspPostInit 0 */
    ...
    PA8     ------> TIM1_CH1
    */
    GPIO_InitStruct.Pin = MMX_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = GPIO_AF1_TIM1;
    HAL_GPIO_Init(MMX_GPIO_Port, &GPIO_InitStruct);
  ...
  /* USER CODE END TIM2_MspPostInit 0 */
    ...
    PB3     ------> TIM2_CH2
    */
    GPIO_InitStruct.Pin = UVL_CTL_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = GPIO_AF1_TIM2;
    HAL_GPIO_Init(UVL_CTL_GPIO_Port, &GPIO_InitStruct);
  ...
  /* USER CODE END TIM4_MspPostInit 0 */
    ...
    PD15     ------> TIM4_CH4
    */
    GPIO_InitStruct.Pin = MFY_Pin|MQJ_Pin|MMS1_Pin|MMS2_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  ...
  /* USER CODE END TIM8_MspPostInit 0 */
    ...
    PC9     ------> TIM8_CH4
    */
    GPIO_InitStruct.Pin = MVAC_Pin|MMZ1_Pin|MMZ2_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  ...
  /* USER CODE END TIM9_MspPostInit 0 */
    ...
    PE5     ------> TIM9_CH1
    */
    GPIO_InitStruct.Pin = HTR_CTL_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = GPIO_AF3_TIM9;
    HAL_GPIO_Init(HTR_CTL_GPIO_Port, &GPIO_InitStruct);
